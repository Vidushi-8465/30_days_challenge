## Day 4 Proj 1: Resume Scorer System

A Python-based Resume Scorer that uses **SpaCy**, **Machine Learning techniques**, and a **custom scoring algorithm** to extract skills, analyze resumes, and rank candidates. It supports **single resume scoring**, **comparison of multiple resumes**, and **folder-based batch processing**.
